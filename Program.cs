...
//_UrunTuruRepository nesnesi(Dependency Injection) olusturulmas�n� sa�lar
builder.Services.AddScoped<IUrunTuruRepository, UrunTuruRepository>();
//_UrunRepository nesnesi(Dependency Injection) olusturulmas�n� sa�lar
